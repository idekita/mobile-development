...
class ListAllRecomendationProjectAdapter(private val listProjectRekomen: List<RecommendationsItem>) :
    RecyclerView.Adapter<ListAllRecomendationProjectAdapter.ViewHolder>(){
